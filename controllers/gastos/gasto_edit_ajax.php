...
function gastoEditAjaxController() {
    global $con;
    ...
    if (!verifyCSRFToken($csrf_token)) {
        error_log('[SECURITY] CSRF token inválido en gasto edit para usuario: ' . getCurrentUsername());
    ...
    try {
        ...
        $result = $gastoModel->updateGasto($id, $fecha, $importe, $period_type_id, $descripcion);
